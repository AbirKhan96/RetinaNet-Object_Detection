...
class GetTrained:
    ...
    def __init__(
        ...
        from_dir = os.path.join(base_dir, model_name)
        ...
        print ("Loading model from ... ", os.path.join(from_dir, "model_final.pth"))
        ...
        # only for RetinaNEt
        self.cfg.MODEL.RETINANET.NUM_CLASSES = len(dta_cfg.thing_classes)
